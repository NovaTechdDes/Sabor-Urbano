...
export const Input = ({type, placeholder, classNameIcon = '', value, onChange, Icon, name, classNameInput = '', classNameDiv = '', onKeyDown, ref}: Props) => {
  return (
    <div className={`my-2 flex bg-neutral-100 dark:bg-neutral-800/80 gap-2.5 border border-neutral-300 dark:border-neutral-700/80 rounded-xl items-center px-3 py-0.5 transition-all focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20 ${classNameDiv}`}>
