...
const Buscador = ({ value, setValue }: Props) => {
  return (
    <div className="space-y-4 max-w-full overflow-hidden pt-8 pb-3">
      <div className="flex mx-1 items-center gap-3 bg-[#F3F4F6] dark:bg-[#1A1A1A] text-gray-800 dark:text-gray-200 px-5 py-3 rounded-full shadow-sm dark:shadow-inner border border-gray-200 dark:border-neutral-800 focus-within:border-primary/50 transition-colors">
